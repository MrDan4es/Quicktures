            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    <div class="card image-card ratio ratio-1x1">
                        <img src="${response.image.url}" class="card-img-top img-block" alt="...">
                        
                        <a href="javascript:void(0);" class="btn p-0 btn-outline-primary btn-inform" id="">
                        ...
                        <a href="javascript:void(0);" class="btn p-0 btn-outline-danger btn-remove" id="">
